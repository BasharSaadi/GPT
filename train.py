...
# Split up dats into train and validation sets
n = int(0.8 * len(data)) # first 90% will be train, rest will be validation
train_data = data[:n]
val_data = data[n:]

block_size = 8 # training in chunks of data 
train_data[:block_size+1]

x = train_data[:block_size] # Inputs to the transformer
y = train_data[1:block_size+1] # Next blocksize characters (targets for each position in the input)
